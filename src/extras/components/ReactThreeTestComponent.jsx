...
var ReactThreeTestComponent = React.createClass({
  displayName: 'ReactThreeTestComponent',
  ...
  render: function() {
    ...
    return  <Scene onclick='console.log("test")' width={this.props.width} height={this.props.height} camera="maincamera">
...
//if I take the "window." off of the function below then I can't access it from App.jsx, how do I export it properly
window.jsxtransformstart = function jsxtransformstart() { // eslint-disable-line no-unused-vars
  var renderelement = document.getElementById("ReactThreeTestComponent");
  var w = 500;
  var h = 500;
  ...
  ReactTHREE.render(<ReactThreeTestComponent {...sceneprops}/>, renderelement);
  ...
  renderelement.onclick = function() {
      playSound(this, '../assets/Itsy_Bitsy_Spider_Dubstep_New.ogg')
  }
  ...
  function playSound(el,soundfile)
  {
      if (el.ogg)
      {
          if(el.ogg.paused) el.ogg.play();
          else el.ogg.pause();
      }
      else
      {
          el.ogg = new Audio(soundfile);
          el.ogg.play();
      }
  }
}
...
module.exports = ReactThreeTestComponent;
exports.jsxtransformstart = jsxtransformstart;
